...
public static void faseCinco() {
	...
	boolean continuar;	
        	...
        	} while ((continuar) && (!((input.hasNextInt()))));        

		while ((eleccionRespuesta!=2) || ((eleccionRespuesta<1) || (eleccionRespuesta>4))) {
			System.out.println("¡Incorrecto! Inténtalo de nuevo (recuerda que las opciones van del 1 al 4):");		
			System.out.print("> ");
			input.next();			
		}
